...
if ($name && $password)
{
	...
	$q = "SELECT userID, userPassword, userName, userPhoneNo, userEmail FROM user WHERE (userName = '$name' AND userPassword = '$password')";
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate"action = "login1.php" method = "POST">
    ...
    <div class="container">
        ...
        <input type="text" id="userID" name="userName" size="30" maxlength="30"
