...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($connect, "INSERT INTO `product`(productName, productPrice, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($connect, "UPDATE `product` SET productName = '$update_p_name', productPrice = '$update_p_price', image = '$update_p_image' WHERE productID = '$update_p_id'");
...
<div class="icon">
<a href="buyerList.php"><img src="user.png" width="71.2" height="71.2" alt="" /></a></div>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="reset" value="cancel"  onclick="history.back()" class="option-btn">
   </form>
